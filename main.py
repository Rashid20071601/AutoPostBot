...
from handlers import mailing_fsm, mailing_manage, mailing_pagination, channel_manage
...
async def main() -> None:
    ...
    for router in (
        mailing_fsm.router,
        mailing_manage.router,
        back.router, mailing_dialog,
        mailing_pagination.router,
